...
<body>
  ...
  private static getInlineCSS(): string {
    return `:root{--sidebar-width:250px;--body-bg-color:rgba(237,237,240,1);--toolbar-bg-color:rgba(249,249,250,1);--toolbar-border-color:rgba(204,204,204,1);--button-hover-color:rgba(221,222,223,1);--main-color:rgba(12,12,13,1);--separator-color:rgba(0,0,0,.3)}@media(prefers-color-scheme:dark){:root{--body-bg-color:rgba(42,42,46,1);--toolbar-bg-color:rgba(56,56,61,1);--toolbar-border-color:rgba(12,12,13,1);--button-hover-color:rgba(102,102,103,1);--main-color:rgba(249,249,250,1);--separator-color:rgba(0,0,0,.3)}}*{box-sizing:border-box;margin:0;padding:0}body{margin:0;padding:0;overflow:hidden;font-family:var(--vscode-font-family);background:var(--body-bg-color);color:var(--main-color)}.docx-viewer-container{display:flex;flex-direction:column;height:100vh}.toolbar{position:relative;background:var(--toolbar-bg-color);border-bottom:1px solid var(--toolbar-border-color);box-shadow:0 1px 0 var(--toolbar-border-color);height:32px;z-index:9999}#toolbarContainer{width:100%;height:32px}#toolbarViewer{display:flex;align-items:center;height:100%;padding:0 4px}#toolbarViewerLeft,#toolbarViewerMiddle,#toolbarViewerRight{display:flex;align-items:center;gap:2px}#toolbarViewerLeft{flex:1}#toolbarViewerMiddle{flex:0 0 auto;justify-content:center;position:absolute;left:50%;transform:translateX(-50%)}#toolbarViewerRight{flex:0 0 auto}.toolbarButton{background:transparent;border:none;color:var(--main-color);padding:2px 6px;cursor:pointer;font-size:12px;border-radius:2px;display:flex;align-items:center;gap:4px;height:28px;min-width:28px;margin:2px 1px;user-select:none;outline:none}.toolbarButton:hover{background:var(--button-hover-color)}.toolbarButton:active{background:rgba(0,0,0,.3);color:#fff}.toolbarButton span{font-size:12px;white-space:nowrap}.splitToolbarButton{display:flex;align-items:center;margin:2px}.splitToolbarButton .toolbarButton{margin:0}.splitToolbarButtonSeparator{width:1px;height:20px;background:var(--separator-color);margin:0 2px}.toolbarLabel{padding:0 8px;font-size:12px;min-width:45px;text-align:center;color:var(--main-color)}.findbar{position:absolute;top:32px;left:50%;transform:translateX(-50%);z-index:999;background:var(--toolbar-bg-color);border:1px solid var(--toolbar-border-color);border-radius:2px;padding:4px 8px;box-shadow:0 2px 8px rgba(0,0,0,.3);display:flex;gap:8px;align-items:center}.findbar.hidden{display:none}.toolbarField{background:rgba(255,255,255,1);border:1px solid rgba(187,187,188,1);color:rgba(6,6,6,1);padding:4px 8px;border-radius:2px;font-size:12px;width:200px;outline:none}@media(prefers-color-scheme:dark){.toolbarField{background:rgba(64,64,68,1);border:1px solid rgba(115,115,115,1);color:rgba(250,250,250,1)}}.toolbarField:focus{border-color:#0a84ff}.docx-outline{position:absolute;left:0;top:32px;bottom:0;width:var(--sidebar-width);background:var(--vscode-sideBar-background,#f3f3f3);border-right:1px solid var(--toolbar-border-color);overflow-y:auto;padding:16px;transition:transform .3s ease;z-index:100}.docx-outline.hidden{transform:translateX(-100%)}.docx-outline h3{margin:0 0 12px 0;font-size:14px;font-weight:600;border-bottom:1px solid var(--toolbar-border-color);padding-bottom:8px}.docx-outline-item{padding:4px 8px;cursor:pointer;border-radius:2px;font-size:12px;margin:2px 0;transition:background .2s ease}.docx-outline-item:hover{background:rgba(0,0,0,.15)}.docx-outline-item.active{background:rgba(0,0,0,.25)}.docx-outline-item.level-1{padding-left:8px;font-weight:600}.docx-outline-item.level-2{padding-left:20px}.docx-outline-item.level-3{padding-left:32px}.docx-outline-item.level-4{padding-left:44px}.docx-outline-item.level-5{padding-left:56px}.docx-outline-item.level-6{padding-left:68px}.docx-content{flex:1;overflow:auto;padding:16px;scroll-behavior:smooth;background:#525659;position:relative}.docx-document{max-width:210mm;min-height:297mm;margin:0 auto;background:#fff;color:#000;box-shadow:0 0 20px rgba(0,0,0,.3);border-radius:2px;padding:40px;line-height:1.6;transform-origin:top center;transition:transform .2s ease}body.vscode-dark .docx-document{background:#2d2d30;color:#d4d4d4}body.vscode-dark .docx-content{background:#1e1e1e}.docx-document h1,.docx-document h2,.docx-document h3,.docx-document h4,.docx-document h5,.docx-document h6{margin:1.5em 0 .5em 0;line-height:1.4}.docx-document p{margin:.8em 0}.docx-document img{max-width:100%;height:auto;margin:1em 0}.docx-document table{border-collapse:collapse;margin:1em 0;width:100%}.docx-document table td,.docx-document table th{border:1px solid #ccc;padding:8px 12px}.docx-document table th{background:#f0f0f0;font-weight:600}.search-highlight{background:#ff0;color:#000;padding:1px 2px;border-radius:2px}body.vscode-dark .search-highlight{background:#f60;color:#fff}.diff-added{background-color:#e6ffec;border-left:4px solid #2ea043}body.vscode-dark .diff-added{background-color:rgba(46,160,67,.15);border-left:4px solid #2ea043}.diff-removed{background-color:#ffebe9;border-left:4px solid red}body.vscode-dark .diff-removed{background-color:rgba(255,0,0,.15);border-left:4px solid red}.verticalToolbarSeparator{display:inline-block;width:1px;height:22px;background:var(--separator-color);margin:0 2px}`;
  }
