            ...
            <div id="toolbarContainer">
                <div id="toolbarViewer">
                    <div id="toolbarViewerLeft">
                        ...
                        <button id="searchBtn" class="toolbarButton" title="Find in Document (Ctrl+F)">
                            <span>🔍</span>
                        </button>
                    </div>
                    <div id="toolbarViewerMiddle">
                        <div class="splitToolbarButton">
                            <button id="zoomOut" class="toolbarButton" title="Zoom Out (Ctrl+-)">
                                <span>−</span>
                            </button>
                            <div class="splitToolbarButtonSeparator"></div>
                            <button id="zoomIn" class="toolbarButton" title="Zoom In (Ctrl++)">
                                <span>+</span>
                            </button>
                        </div>
                        ...
                        <button id="resetZoom" class="toolbarButton" title="Reset Zoom (Ctrl+0)">
                            <span>⚊</span>
                        </button>
                    </div>
