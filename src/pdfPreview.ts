      ...
      webviewEditor.webview.onDidReceiveMessage((message) => {
        switch (message.type) {
          ...
          case 'open-in-browser': {
            vscode.env.openExternal(vscode.Uri.file(resource.fsPath));
            break;
          }
        }
      })
  ...
  window.addEventListener('DOMContentLoaded', () => {
    ...
    if (fitWidthBtn) {
      fitWidthBtn.addEventListener('click', () => {
        const scaleSelect = document.getElementById('scaleSelect');
        if (scaleSelect) scaleSelect.value = 'page-width';
        scaleSelect.dispatchEvent(new Event('change'));
      });
    }
  });
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div style="display:none;">
                ...
                <button id="openInBrowser" class="toolbarButton" title="Open in Browser" tabindex="49">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                    <path d="M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm5.9 7H11c-.1-1.5-.4-2.9-.8-4.1 1.6.7 2.9 2 3.7 3.6zM8 14c-.5 0-1.5-1.5-2-4h4c-.5 2.5-1.5 4-2 4zm-2.3-5c-.1-.7-.1-1.3-.1-2s0-1.3.1-2h4.6c.1.7.1 1.3.1 2s0 1.3-.1 2H5.7zM2 8c0-.7.1-1.4.3-2h2.8c-.1.7-.1 1.3-.1 2s0 1.3.1 2H2.3C2.1 9.4 2 8.7 2 8zm3.2-5.1C4.8 4.1 4.5 5.5 4.4 7H1.5c.8-1.6 2.1-2.9 3.7-3.6zM1.5 9h2.9c.1 1.5.4 2.9.8 4.1C3.6 12.4 2.3 11.1 1.5 9zm8.3 4.1c.4-1.2.7-2.6.8-4.1h2.9c-.8 1.6-2.1 2.9-3.7 3.6z"/>
                  </svg>
                </button>
              ...
              <div id="toolbarViewerMiddle">
                ...
                <button id="resetZoom" class="toolbarButton" title="Reset Zoom (100%)" tabindex="50">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                    <text x="8" y="12" font-size="11" font-weight="bold" text-anchor="middle" fill="currentColor">R</text>
                  </svg>
                </button>
                <button id="fitWidth" class="toolbarButton" title="Fit to Width" tabindex="51">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                    <text x="8" y="12" font-size="11" font-weight="bold" text-anchor="middle" fill="currentColor">F</text>
                  </svg>
                </button>
              </div>
            </div>
